...
//  EssentialApp
//
//  Created by Jason Ou on 2023/4/14.
//
...
extension DispatchQueue {
    ...
    struct ImmediateWhenOnMainQueueScheduler: Scheduler {
        ...
        func schedule(after date: SchedulerTimeType, interval: DispatchQueue.SchedulerTimeType.Stride, tolerance: DispatchQueue.SchedulerTimeType.Stride, options: DispatchQueue.SchedulerOptions?, _ action: @escaping () -> Void) -> Cancellable {
